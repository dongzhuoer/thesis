...
knitr::include_graphics('lem4-promote-breast-cancer.png')
```
...
knitr::include_graphics('probe-to-symbol.png')
```
...
knitr::include_graphics('qGSEA-usage.jpeg')
```
...
ggplot(read_rds('significant_per_dataset.rds')) + 
...
knitr::include_graphics('geneset-overlap.jpeg')
```
