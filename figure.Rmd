...
knitr::opts_chunk$set(fig.width = 6, fig.height = 4.5, fig.path = 'figure/ppt/') 
```
...
You can run `Rscript -e "rmarkdown::render('index.Rmd')"` in [thesis repo](https://github.com/dongzhuoer/thesis) to reproduce this.
...
## [rGEO](https://dongzhuoer.github.io/thesis/rGEO) 的成效
...
# Figures used in thesis document



## [图 4](https://dongzhuoer.github.io/thesis/gitbook/result.html#fig:rGEO-performance): rGEO的表现
...
## [图 6](https://dongzhuoer.github.io/thesis/gitbook/result.html#fig:significant-geneset-per-dataset): 各个集合在不同数据集中的整体表现
